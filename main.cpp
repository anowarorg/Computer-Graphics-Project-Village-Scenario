...
///   Flower Right Branch
    ...
    /// [ Boat ]
/// Boat Body Rectangle
    glColor3ub(85, 107, 47); // Change boat body color to olive green
    glBegin(GL_QUADS);
...
/// Boat Right Corners
    glColor3ub(85, 107, 47); // Change boat corner color to olive green
    glBegin(GL_TRIANGLES);
...
/// [ Home ]
/// Home Shed
glColor3ub(255, 69, 0); // Changed color to red-orange
glBegin(GL_QUADS);
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow ("Village_scenario");
